<?php return array(
    ...
    */
     ...
     * @var string
     */
    'path' => 'cache/(coaster.*|uploads.*|themes.*)',

    /**
     * Additional setting to convert generated url in Croppa::url() to cache
     */
    'url_replace' => [
        '/^(coaster.*|uploads.*|themes.*)\//' => 'cache/$1/',
    ],
     ...
     */
    // 'url_prefix' => '//'.request()->getHttpHost().'/cache/',
